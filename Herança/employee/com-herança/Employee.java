...
public class Employee {
	   ...
	   protected double grossSales; //vendas brutas na semana
	   protected double commissionRate; //porcentagem de comissao sobre as vendas
	
	   public Employee(String firstName, String lastName,
          String socialSecurityNumber, double grossSales, 
	      double commissionRate) {
            //Sempre ha uma chama implicita ao constructor padrao da classe pai.
